...
static void app_draw_callback(Canvas* canvas, void* ctx) {
    ...
    canvas_draw_str(canvas, 2, 12, "Sub-GHz AI Analyzer");
    ...
    char pkts_str[32];
    snprintf(pkts_str, sizeof(pkts_str), "Signaux: %lu", state->packet_count);
    canvas_draw_str(canvas, 2, 52, pkts_str);

    canvas_draw_line(canvas, 0, 55, 128, 55);
    canvas_draw_str(canvas, 2, 64, "[<>] Freq | [OK] Reset");
